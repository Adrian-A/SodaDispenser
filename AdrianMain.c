...
void timer1_init() {
	...
	TCCR1B = (1 << CS11);        // Start Timer1 with prescaler = 8 (1 tick = 0.5 탎 at 16 MHz)
}
...
//
	...
	uint16_t timeout = 38000; // 38 ms timeout = 76000 timer ticks at 0.5 탎 per tick
	...
	timeout = 76000; // Max echo high time in ticks (38 ms / 0.5 탎)
	...
	return TCNT1; // Duration of HIGH pulse (in 0.5 탎 units)
}
